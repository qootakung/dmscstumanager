      ...
      <CardContent className="space-y-4 text-sm text-blue-700">
        ...
        <div className="bg-white p-3 rounded-lg border border-blue-200">
          ...
          <ul className="text-xs space-y-1 list-disc list-inside">
            <li>เลือกปีการศึกษา / ภาคเรียน / เดือน ด้านบนให้ถูกต้องก่อนส่งออกหรือนำเข้า</li>
            <li>ถ้าแถวใดไม่ได้กรอกวันที่ชั่ง ระบบจะใช้เดือนที่เลือกไว้ด้านบนให้อัตโนมัติ</li>
