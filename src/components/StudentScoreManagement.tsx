...
const SUBJECTS_BY_GRADE: Record<string, Subject[]> = {
  'ป.1': [
    ...
    { code: 'ว11102', name: 'วิทยาการคำนวณ' }
  ],
  'ป.2': [
    ...
    { code: 'ว12102', name: 'วิทยาการคำนวณ' }
  ],
  'ป.3': [
    ...
    { code: 'ว13102', name: 'วิทยาการคำนวณ' }
  ],
  'ป.4': [
    ...
    { code: 'ว14102', name: 'วิทยาการคำนวณ' },
    { code: 'ว14202', name: 'วิทย์พลังสิบ' }
  ],
  'ป.5': [
    ...
    { code: 'ว15102', name: 'วิทยาการคำนวณ' },
    { code: 'ว15202', name: 'วิทย์พลังสิบ' }
  ],
  'ป.6': [
    ...
    { code: 'ว16102', name: 'วิทยาการคำนวณ' },
    { code: 'ว16202', name: 'วิทย์พลังสิบ' }
  ]
};
